...
jQuery.sap.declare("fish.foster.HorizontalBarChart");

sap.ui.core.Element.extend("fish.foster.HorizontalBarChartItem", { metadata : {
	properties : {
...
sap.ui.core.Control.extend("fish.foster.HorizontalBarChart", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "HorizontalBarChart Title"}
		},
		aggregations : {
			"items" : { type: "fish.foster.HorizontalBarChartItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("fish.foster.HorizontalBarChart.init()");
		this.sParentId = "";
	},
	...
	createHorizontalBarChart : function() {
		 ...
		 */
		console.log("fish.foster.HorizontalBarChart.createHorizontalBarChart()");
	...
	onAfterRendering: function(){
		console.log("fish.foster.HorizontalBarChart.onAfterRendering()");
